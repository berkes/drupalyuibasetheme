<?php
// $Id: template.php,v 1.2.2.5 2009/05/11 20:28:34 jmburnz Exp $

/**
 * @file template.php
 * 
 * USAGE
 * 1. Rename each function to match your subthemes name, i.e.
 *    replace genesis_SUBTHEME with your subthemes name.
