...
*:  CREATE A NEW SUBTHEME
   ...
   3. Inside the genesis_foo.info file change:
       - the theme name
       - the description
       
       Gpanels: if you want to use the Gpanels uncomment the additional regions for Gpanels.
       
       IE CSS: if you want to use and IE stylesheet follow the instructions in the info 
       file for downloading the Conditional Styles module and setting up the stylesheets.
       
       Equal hight columns: uncomment the jQuery script in genesis_foo.info.
       
       WAI ARIA Roles: by default these are enabled. If for some reason you do not want them
       simply comment out the jQuery script in genesis_foo.info.
       
       Read the info file thouroughly!
